               ...
               <section class="col4 pad_left">
                  <div class="wrapper">
                     ...
                     <div class="col4 pad_left">
                        <h3>HTML5 – język wykorzystywany do tworzenia i prezentowania stron internetowych www...</h3><!-- NAZWA -->
                        <img class="graf" src="images/nazwa_obrazu2.jpg"/><!-- OBRAZ -->
                        <p>HTML5 poza dodaniem nowych elementów, usprawniających tworzenie serwisów i aplikacji internetowych, doprecyzowuje wiele niejasności w specyfikacji HTML 4, dotyczących przede wszystkim sposobu obsługi błędów. Niejasności co do sposobu, w jaki przeglądarki powinny obsługiwać błędy w kodzie HTML są jedną z podstawowych przyczyn, dla której wiele serwisów internetowych, napisanych z naruszeniem specyfikacji, w różnych przeglądarkach działa w inny sposób – w niektórych działając, w innych nie. Dzięki HTML-owi 5 obsługa błędów ma być ta sama we wszystkich przeglądarkach, czyli zły element będzie działać w każdej przeglądarce albo żadnej</p>
                        ...
                        $query ="SELECT * FROM znaczniki WHERE jezyk='html' and poziom='3'";
