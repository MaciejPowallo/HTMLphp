               ...
               <section class="col4 pad_left">
                  <div class="wrapper">
                     ...
                     <div class="col4 pad_left">
                        <h3>PHP jako interpretowany skryptowy język programowania...</h3><!-- NAZWA -->
                        <img class="graf" src="images/nazwa_obrazu2.jpg"/><!-- OBRAZ -->
                        <!-- TEKST --><p>PHP jest popularnym uniwersalnym językiem skryptowym, który jest szczególnie przystosowany do tworzenia stron WWW. PHP jest najczęściej stosowany do tworzenia skryptów po stronie serwera WWW, ale może być on również używany do przetwarzania danych z poziomu wiersza poleceń, a nawet do pisania programów pracujących w trybie graficznym (np. za pomocą biblioteki GTK+, używając rozszerzenia PHP-GTK). Implementacja PHP wraz z serwerem WWW Apache oraz serwerem baz danych MySQL określana jest jako platforma AMP (w środowisku Linux – LAMP, w Windows – WAMP).</p>
                        ...
                        $query ="SELECT * FROM znaczniki WHERE jezyk='php' and poziom='1'";
