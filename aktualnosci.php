                     ...
                     <div class="col4 pad_left">
                        ...
                        <div class="border_news">
                           <table class="date">
                              <tr>
                                 <td>
                                    <h6 style="padding-top:6px;font-size:10px; color:#ffffff">2016</h6>04.10
                                 </td>
                              </tr>
                           </table>
                           <b class="title_news"><h3 style="color:#440000">Powstanie strony HTMLphp.pl</h3></b>
                           <div class="width_news">Mamy przyjemność zaprezentować Państwu stronę HTMLphp, która powstała w 2016 roku i służy do nauki zarówno podstaw tworzenia stron jak również zaawansowanych fukcji języków PHP, HTML i CSS
                              <table class="gal">
                                 <tr>
                                    <td class="gal"><a href="images/aktualnosci/001.jpg" data-lightbox="roadtrip"><img src="images/aktualnosci/001.jpg" class="img_gal" ></a></td>
                                    <td class="gal"><a href="images/aktualnosci/002.jpg" data-lightbox="roadtrip"><img src="images/aktualnosci/002.jpg" class="img_gal" ></a></td>
                                    <td class="gal"><a href="images/aktualnosci/003.jpg" data-lightbox="roadtrip"><img src="images/aktualnosci/003.jpg" class="img_gal" ></a></td>
                                 </tr>
                                 <tr>
                                    <td class="gal"><a href="images/aktualnosci/004.jpg" data-lightbox="roadtrip"><img src="images/aktualnosci/004.jpg" class="img_gal" ></a></td>
                                    <td class="gal"><a href="images/aktualnosci/005.jpg" data-lightbox="roadtrip"><img src="images/aktualnosci/005.jpg" class="img_gal" ></a></td>
                                    <td class="gal"><a href="images/aktualnosci/006.jpg" data-lightbox="roadtrip"><img src="images/aktualnosci/006.jpg" class="img_gal" ></a></td>
                                 </tr>
                              </table>
                           </div>					
                           <!-- KONIEC NEWSA -->
