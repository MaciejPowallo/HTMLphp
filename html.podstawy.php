               ...
               <section class="col4 pad_left">
                  <div class="wrapper">
                     ...
                     <div class="col4 pad_left">
                        <h3>HTML powstał w 1993 roku...</h3><!-- NAZWA -->
                        <img class="graf" src="images/nazwa_obrazu2.jpg"/><!-- OBRAZ -->
                        <!-- TEKST --><p>HTML pozwala opisać strukturę informacji zawartych wewnątrz strony internetowej, nadając znaczenie poszczególnym fragmentom tekstu – formując hiperłącza, akapity, nagłówki, listy – oraz osadza w tekście dokumentu obiekty plikowe np. multimedia bądź elementy baz danych np. interaktywne formularze danych.
                        HTML umożliwia określenie wyglądu dokumentu w przeglądarce internetowej. Do szczegółowego opisu formatowania akapitów, nagłówków, użytych czcionek i kolorów, zalecane jest wykorzystywanie kaskadowych arkuszy stylów.</p>
                        ...
                        $query ="SELECT * FROM znaczniki WHERE jezyk='html' and poziom='1'";
